...
public class AutoQuoteFromExcel {

	public AutoQuoteFromExcel(WebDriver driver) {
	...
	public void autoQuoteExcelSteps(CommonMethods cm,int zipCode, String stAddress,String apt) {
